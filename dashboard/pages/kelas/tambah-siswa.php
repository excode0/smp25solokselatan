    ...
    <div class="col-span-12 mt-5">
        <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
            <div class="bg-white p-8 rounded shadow-md w-full">
                ...
                <form action="../kelas/prosses?tipe=tambah_siswa" method="post">
                    <!-- Nama -->
                    <div class="mb-4">
                        <label for="nama" class="block text-gray-600 text-sm font-medium mb-2">Nama</label>
                        <input type="text" id="nama" name="nama" class="form-input w-full rounded-md p-2" placeholder="Masukkan nama">
                    </div>
                    ...
                    <!-- Lokal Dropdown -->
                     ...
                     <div class="mb-6">
                        ...
                        <select id="lokal" name="lokal" class="form-select w-full rounded-md p-2"></select>
                    </div>
...
<script>
    function getLokalData() {
        ...
        xhttp.open("GET", "../kelas/get_lokal_data?kelas=" + selectedKelas, true);
        xhttp.send();
    }
</script>
