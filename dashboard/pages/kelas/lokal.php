    ...
    <div class="col-span-12 mt-5">
        <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
            <div class="bg-white p-8 rounded shadow-md w-full">
                <h1 class="text-2xl font-semibold mb-6">Form Lokal</h1>

                <form action="../kelas/prosses?tipe=tambah_lokal" method="post">
                    <!-- Nama lokal -->
                    <div class="mb-4">
                        <label for="nama_lokal" class="block text-gray-600 text-sm font-medium mb-2">Nama Lokal</label>
                        <input type="text" id="nama_lokal" name="nama_lokal" class="form-input w-full rounded-md p-2" placeholder="Masukkan nama Lokal">
                    </div>

                    <!-- Kelas Dropdown -->
                    <div class="mb-4">
                        <label for="kelas" class="block text-gray-600 text-sm font-medium mb-2">Kelas</label>
                        <select id="kelas" name="kelas" class="form-select w-full rounded-md p-2">
                            <?php
